...
object PhotoDownloader {
    ...
    fun getPhotos(context: Context, urlList: ArrayList<String>, amount: Int = DEFAULT_AMOUNT, adapter: PhotoAdapter) {
        ...
        val request = "$URL$apiKey$SAFE_SEARCH_URL$PHOTO_AMOUNT_URL$perPage"
        ...
        }, Response.ErrorListener { e -> Log.d("blad_get", e.networkResponse.toString()) })
